...
C {opin.sym} 410 -590 0 0 {name=p3 lab=output
}
...
descr="load waves" 
tclcommand="xschem raw_read ; xschem raw_read $netlist_dir/rf_sequence.raw ac "
}
C {launcher.sym} 300 10 0 0 {name=h1
descr="run sim" 
tclcommand="echo ===== STARTING ===== ; cd $netlist_dir ; echo "exit" | ngspice ./rf_sequence.spice ; echo ===== DONE ====="
}
...
echo ===== START ===== ; 
xschem netlist ;
cd $netlist_dir ; echo "exit" | ngspice ./rf_sequence.spice ; 
xschem raw_read ; xschem raw_read $netlist_dir/rf_sequence.raw ac ;
echo ===== DONE =====
"
}
C {./rf_mixer.sym} 310 -590 0 0 {name=x1}
C {ipin.sym} 220 -580 0 0 {name=p5 lab=lo
}
C {./rf_filter.sym} -190 -590 0 0 {name=x2}
C {./rf_amplifier.sym} 0 -590 0 0 {name=x3}
