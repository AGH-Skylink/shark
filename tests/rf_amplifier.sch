...
descr="load waves" 
tclcommand="xschem raw_read ; xschem raw_read $netlist_dir/rf_amplifier.raw ac "
}
C {launcher.sym} 300 -170 0 0 {name=h1
descr="run sim" 
tclcommand="echo ===== STARTING ===== ; cd $netlist_dir ; echo "exit" | ngspice ./rf_amplifier.spice ; echo ===== DONE ====="
}
...
echo ===== START ===== ; 
xschem netlist ;
cd $netlist_dir ; echo "exit" | ngspice ./rf_amplifier.spice ; 
xschem raw_read ; xschem raw_read $netlist_dir/rf_amplifier.raw ac ;
echo ===== DONE =====
"
}
C {./rf_amplifier.sym} 0 -780 0 0 {name=x1}
