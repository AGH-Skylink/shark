...
C {./../schematic/top_level.sym} 0 -770 0 0 {name=x1}
C {ipin.sym} -150 -770 0 0 {name=p1 lab=input
}
C {opin.sym} 150 -770 0 0 {name=p3 lab=output
}
C {ipin.sym} 0 -820 0 0 {name=p2 lab=vdd}
C {ipin.sym} 0 -720 0 0 {name=p4 lab=vss}
...
descr="load waves" 
tclcommand="xschem raw_read ; xschem raw_read $netlist_dir/entire_system.raw ac "
}
C {launcher.sym} 290 -170 0 0 {name=h1
descr="run sim" 
tclcommand="echo ===== STARTING ===== ; cd $netlist_dir ; echo "exit" | ngspice ./entire_system.spice ; echo ===== DONE ====="
}
...
echo ===== START ===== ; 
xschem netlist ;
cd $netlist_dir ; echo "exit" | ngspice ./entire_system.spice ; 
xschem raw_read ; xschem raw_read $netlist_dir/entire_system.raw ac ;
echo ===== DONE =====
"
}
