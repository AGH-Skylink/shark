...
C {ipin.sym} -90 -600 0 0 {name=p1 lab=input
}
C {opin.sym} 100 -590 0 0 {name=p3 lab=output
}
...
descr="load waves" 
tclcommand="xschem raw_read ; xschem raw_read $netlist_dir/rf_mixer.raw ac "
}
C {launcher.sym} 300 10 0 0 {name=h1
descr="run sim" 
tclcommand="echo ===== STARTING ===== ; cd $netlist_dir ; echo "exit" | ngspice ./rf_mixer.spice ; echo ===== DONE ====="
}
...
echo ===== START ===== ; 
xschem netlist ;
cd $netlist_dir ; echo "exit" | ngspice ./rf_mixer.spice ; 
xschem raw_read ; xschem raw_read $netlist_dir/rf_mixer.raw ac ;
echo ===== DONE =====
"
}
C {./rf_mixer.sym} 0 -590 0 0 {name=x1}
C {ipin.sym} -90 -580 0 0 {name=p5 lab=lo
}
